    ...
    <section className="relative min-h-screen flex items-center justify-center hero-gradient pt-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <a
            href="#"
            className="px-8 py-4 bg-fugle-500 hover:bg-fugle-600 text-black font-semibold rounded-xl text-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
          >
          ...
          <a
            href="#quickstart"
            className="px-8 py-4 border-2 border-fugle-500 text-fugle-500 hover:bg-fugle-500/10 font-semibold rounded-xl text-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        >
          ...
          >
            <div className="w-1.5 h-3 bg-fugle-500 rounded-full" />
          </motion.div>
        </motion.div>
      </div>
    </section>
